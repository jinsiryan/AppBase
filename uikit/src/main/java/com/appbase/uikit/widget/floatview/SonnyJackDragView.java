package com.appbase.uikit.widget.floatview;
...
public class SonnyJackDragView{
    ...
    public void addDragTouch(View view){
        view.setOnTouchListener(new DragTouch());
    }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    left = dragView.getLeft() + dx;
                    if (left < 0) {
                        left = 0;
                    }
                    right = left + dragView.getWidth();
                    if (right > mScreenWidth) {
                        right = mScreenWidth;
                        left = right - dragView.getWidth();
                    }
                    top = dragView.getTop() + dy;
                    if (top < mStatusBarHeight + 2) {
                        top = mStatusBarHeight + 2;
                    }
                    bottom = top +dragView.getHeight();
                    if (bottom > mScreenHeight) {
                        bottom = mScreenHeight;
                        top = bottom - dragView.getHeight();
                    }
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    dragView.setLayoutParams(createLayoutParams(dragView.getLeft(),dragView.getTop(), 0, 0));
